...
OBJECTOS = main.o configuration.o hospsignal.o hosptime.o stats.o log.o synchronization.o doctor.o memory.o patient.o receptionist.o process.o
...
#-----------------------------------------------------------------------------------
out: $(OBJECTOS)
	@$(CC)$(addprefix $(OBJ_dir)/,$(OBJECTOS)) -o $(BIN_dir)/$(FILENAME)
